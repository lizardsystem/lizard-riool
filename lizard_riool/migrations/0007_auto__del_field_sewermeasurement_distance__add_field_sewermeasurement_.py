...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SewerMeasurement.distance'
        db.delete_column('lizard_riool_sewermeasurement', 'distance')

        # Adding field 'SewerMeasurement.dist'
        db.add_column('lizard_riool_sewermeasurement', 'dist',
                      self.gf('django.db.models.fields.FloatField')(default=0, db_column='distance'),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SewerMeasurement.distance'
        raise RuntimeError("Cannot reverse this migration. 'SewerMeasurement.distance' and its values cannot be restored.")
        # Deleting field 'SewerMeasurement.dist'
        db.delete_column('lizard_riool_sewermeasurement', 'distance')
    ...
    models = {
        ...
        'lizard_riool.sewermeasurement': {
            ...
            'dist': ('django.db.models.fields.FloatField', [], {'db_column': "'distance'"}),
