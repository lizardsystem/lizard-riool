...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Sewerage.rmb'
        raise RuntimeError("Cannot reverse this migration. 'Sewerage.rmb' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Sewerage.rib'
        raise RuntimeError("Cannot reverse this migration. 'Sewerage.rib' and its values cannot be restored.")
