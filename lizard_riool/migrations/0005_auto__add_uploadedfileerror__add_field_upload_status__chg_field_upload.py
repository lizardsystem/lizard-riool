...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_riool_uploadedfileerror', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uploaded_file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_riool.Upload'])),
        ...
        db.send_create_signal('lizard_riool', ['UploadedFileError'])

        # Adding field 'Upload.status'
        db.add_column('lizard_riool_upload', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True),
                      keep_default=False)


        # Changing field 'Upload.the_file'
        db.alter_column('lizard_riool_upload', 'the_file', self.gf('django.db.models.fields.FilePathField')(path='/home/remcogerlich/src/git/almere-site/var/lizard_riool/uploads', max_length=100))

    def backwards(self, orm):
        # Deleting model 'UploadedFileError'
        db.delete_table('lizard_riool_uploadedfileerror')

        # Deleting field 'Upload.status'
        db.delete_column('lizard_riool_upload', 'status')


        # Changing field 'Upload.the_file'
        db.alter_column('lizard_riool_upload', 'the_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        'lizard_riool.upload': {
            ...
            'the_file': ('django.db.models.fields.FilePathField', [], {'path': "'/home/remcogerlich/src/git/almere-site/var/lizard_riool/uploads'", 'max_length': '100'}),
