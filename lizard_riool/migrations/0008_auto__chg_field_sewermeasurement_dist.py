...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'SewerMeasurement.dist' to match new field type.
        db.rename_column('lizard_riool_sewermeasurement', 'distance', 'dist')
        # Changing field 'SewerMeasurement.dist'
        db.alter_column('lizard_riool_sewermeasurement', 'dist', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Renaming column for 'SewerMeasurement.dist' to match new field type.
        db.rename_column('lizard_riool_sewermeasurement', 'dist', 'distance')
        # Changing field 'SewerMeasurement.dist'
        db.alter_column('lizard_riool_sewermeasurement', 'distance', self.gf('django.db.models.fields.FloatField')(db_column='distance'))
