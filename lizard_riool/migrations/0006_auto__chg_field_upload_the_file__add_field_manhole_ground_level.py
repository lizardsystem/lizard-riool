...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Manhole.ground_level'
        db.add_column('lizard_riool_manhole', 'ground_level',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Manhole.ground_level'
        db.delete_column('lizard_riool_manhole', 'ground_level')
