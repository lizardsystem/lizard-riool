...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Manhole.sewerage'
        db.alter_column('lizard_riool_manhole', 'sewerage_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['lizard_riool.Sewerage']))

    def backwards(self, orm):

        # Changing field 'Manhole.sewerage'
        db.alter_column('lizard_riool_manhole', 'sewerage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_riool.Sewerage'], null=True))
