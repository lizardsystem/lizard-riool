...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for manhole in orm['lizard_riool.Manhole'].objects.all():
            sewer = orm['lizard_riool.Sewer'].objects.filter(Q(manhole1=manhole) | Q(manhole2=manhole))[0]
            manhole.sewerage = sewer.sewerage
            manhole.save()

    def backwards(self, orm):
        for manhole in orm['lizard_riool.Manhole'].objects.all():
            manhole.sewerage = None
            manhole.save()
