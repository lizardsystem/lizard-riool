...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Upload.the_file'
        db.alter_column('lizard_riool_upload', 'the_file', self.gf('django.db.models.fields.FilePathField')(path='/home/remcogerlich/src/git/almere-site/var/lizard_riool/uploads', max_length=400))

        # Changing field 'Sewerage.rmb'
        db.alter_column('lizard_riool_sewerage', 'rmb', self.gf('django.db.models.fields.FilePathField')(max_length=400, null=True, path='/home/remcogerlich/src/git/almere-site/var/lizard_riool/sewerages'))

        # Changing field 'Sewerage.rib'
        db.alter_column('lizard_riool_sewerage', 'rib', self.gf('django.db.models.fields.FilePathField')(max_length=400, null=True, path='/home/remcogerlich/src/git/almere-site/var/lizard_riool/sewerages'))

    def backwards(self, orm):

        # Changing field 'Upload.the_file'
        db.alter_column('lizard_riool_upload', 'the_file', self.gf('django.db.models.fields.FilePathField')(path='/home/byrman/Repo/almere-site/var/lizard_riool/uploads', max_length=100))

        # Changing field 'Sewerage.rmb'
        db.alter_column('lizard_riool_sewerage', 'rmb', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Sewerage.rib'
        db.alter_column('lizard_riool_sewerage', 'rib', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
